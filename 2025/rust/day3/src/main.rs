...
fn find_max_joltage(value: &str) -> u32 {
...
fn solve_part_1(puzzle: &str) -> u32 {
    puzzle.lines().map(find_max_joltage).sum()
}
...
mod tests {
    ...
    fn test_find_max_joltage() {
        ...
        assert_eq!(find_max_joltage("818181911912111"), 99);
        assert_eq!(find_max_joltage("918181191112119"), 99);
        assert_eq!(find_max_joltage("918181911112111"), 99);
    }
}
